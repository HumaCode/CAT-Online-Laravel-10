<x-master-layout>
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Kategori Ujian</li>
                            </ol>
                        </div>
            ...
            <div class="col-lg-12">
                <div class="card" data-aos="zoom-in">
                    <div class="card-header">
                        @can('create main-menu/kategori-ujian')
                            <a href="{{ route('main-menu.kategori-ujian.create') }}"
                                class="btn btn-primary btn-animation float-end waves-effect waves-light action"> <i
                                    class="mdi mdi-plus"></i> &nbsp; Tambah
                            </a>
                        @endcan

                        <h6 class="card-title mb-0">Kategori Ujian</h6>
                    </div>
                    <div class="card-body">
    ...
    @push('js')
        ...
        <script>
            ...
            var table;
            var url = '{{ route('main-menu.kategori-ujian.data') }}';
            var columns = [{
                    data: 'kategori',
                    name: 'kategori'
                },
